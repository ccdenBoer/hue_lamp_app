...
fun colorToHue(color: Color): Triple<Int, Short, Short> {
    ...
    val saturationShort = (hsb[1] * 254).toInt().toShort() // Convert saturation to 8-bit integer
    val brightnessShort = (hsb[2] * 254).toInt().toShort() // Convert brightness to 8-bit integer
